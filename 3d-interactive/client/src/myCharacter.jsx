...
/*export*/ function MyCharacter({name="noName", refOrbitControls,...props},refRigid) {
  ...
  return (
    ...
    <group ref={refModel} {...props} dispose={null} position-y={-characterHeight/2}>
  ...
  const getDirectionOffset = useCallback((keys)=>{
    ...
    if(keys.forward){
      ...
      if(keys.leftward){
        ...
        directionOffset = - MathPI/4 - Math.PI/2;
      }else{
